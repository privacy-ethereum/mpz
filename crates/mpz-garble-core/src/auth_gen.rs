...
impl<'a> AuthGenerator<'a> {
    ...
    /// Returns the triples generated by the generator.
    pub fn output_triples(&self) -> Vec<AuthTripleShare> {
        self.fpre.triple_shares.clone()
    }
    ...
    /// output sigma bits for debugging
    pub fn output_sigma_bits(&self) -> Vec<AuthBitShare> {
        self.sigma_bits.clone()
    }

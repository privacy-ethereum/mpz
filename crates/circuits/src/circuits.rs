...
pub mod blake3 {
    ...
    /// Returns a Blake3 compression circuit.
    ...
    pub(crate) fn round(builder: &mut CircuitBuilder, state: &mut State, msg: &Msg) {
        // Mix columns.
...
mod tests {
    ...
    fn blake3_round(state: &mut [u32; 16], m: &[u32; 16]) {
        // Mix the columns.
        blake3_mix(state, 0, 4, 8, 12, m[0], m[1]);
        blake3_mix(state, 1, 5, 9, 13, m[2], m[3]);
        blake3_mix(state, 2, 6, 10, 14, m[4], m[5]);
        blake3_mix(state, 3, 7, 11, 15, m[6], m[7]);
        // Mix the diagonals.
        blake3_mix(state, 0, 5, 10, 15, m[8], m[9]);
        blake3_mix(state, 1, 6, 11, 12, m[10], m[11]);
        blake3_mix(state, 2, 7, 8, 13, m[12], m[13]);
        blake3_mix(state, 3, 4, 9, 14, m[14], m[15]);
    }

    #[cfg(feature = "blake3")]
    // Ref: https://github.com/BLAKE3-team/BLAKE3/blob/3a90f0f06a429e6ce1d337b28156a75d2a372d7b/reference_impl/reference_impl.rs#L66-L72.
    fn blake3_permute(m: &mut [u32; 16]) {
        use crate::circuits::blake3::MSG_PERMUTATION;
    ...
    #[cfg(feature = "blake3")]
    // Ref: https://github.com/BLAKE3-team/BLAKE3/blob/3a90f0f06a429e6ce1d337b28156a75d2a372d7b/reference_impl/reference_impl.rs#L74-L111.
    fn blake3_compress(block: &mut [u32; 16], state: &mut [u32; 16]) {
    ...
    fn test_blake3_mix() {
        ...
        // Test case 1: All ones
        {
            ...
            blake3_mix(&mut state, 0, 1, 2, 3, 1u32, 1u32);
        ...
        // Test case 2: All zeros (edge case)
        {
            ...
            blake3_mix(&mut state, 0, 1, 2, 3, 0u32, 0u32);
        ...
        // Test case 3: Max values (overflow testing)
        {
            ...
            blake3_mix(&mut state, 0, 1, 2, 3, u32::MAX, u32::MAX);
        ...
        // Test case 4: Sequential values
        {
            ...
            blake3_mix(&mut state, 0, 1, 2, 3, 16u32, 17u32);
        ...
        // Test case 5: Powers of two
        {
            ...
            blake3_mix(&mut state, 0, 1, 2, 3, msg_vals[0], msg_vals[1]);
        ...
        // Test case 6: Mix of zero and non-zero values
        {
            ...
            state[2] = 0u32;
            state[3] = u32::MAX;
            blake3_mix(&mut state, 0, 1, 2, 3, 0x12345678u32, 0x9abcdef0u32);
        ...
        // Test case 7: Large random-like values
        {
            ...
            blake3_mix(&mut state, 0, 1, 2, 3, 0x11111111u32, 0x22222222u32);
        ...
        // Test case 8: Values with alternating bit patterns
        {
            ...
            blake3_mix(&mut state, 0, 1, 2, 3, 0xF0F0F0F0u32, 0x0F0F0F0Fu32);
        ...
        // Test case 9: Single bit set values
        {
            ...
            state[2] = 1u32 << 7;
            state[3] = 1u32 << 0;
            blake3_mix(&mut state, 0, 1, 2, 3, 1u32 << 16, 1u32 << 8);
    ...
    fn test_blake3_round() {
        ...
        let test_m = [0u32; 16];
        blake3_round(&mut expected_state, &test_m);
    ...
    fn test_blake3_compress() {
        ...
        // Test case 1: All zeros
        {
            ...
            blake3_compress(&mut test_msg, &mut test_state);
